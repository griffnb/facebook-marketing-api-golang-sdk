...
type Campaign struct {
	...
	BudgetScheduleSpecs      []interface{} `json:"budget_schedule_specs,omitempty"`
	BuyingType               string        `json:"buying_type,omitempty"`
	CampaignOptimizationType string        `json:"campaign_optimization_type,omitempty"`
	...
	IsUsingL3Schedule        bool          `json:"is_using_l3_schedule,omitempty"`
	...
	PromotedObject           interface{}   `json:"promoted_object,omitempty"`
